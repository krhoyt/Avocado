...
export default {
  ...
  computed: {
    account: {
      get: function() {
        return this.$store.getters['picklist/skills/ACCOUNT'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/skills/SET_ACCOUNT', value );
      }
    },
    color: {
      get: function() {
        return this.$store.getters['picklist/skills/COLOR'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/skills/SET_COLOR', value );
      }
    },
    color_id: {
      get: function() {
        return this.$store.getters['picklist/skills/COLOR_ID'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/skills/SET_COLOR_ID', value );
      }
    },
    colors: {
      get: function() {
    ...
    count: {
      get: function() {
        return this.$store.getters['picklist/skills/COUNT'].toString();
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/skills/SET_COUNT', value );
      }
    },
    id: {
      get: function() {
        return this.$store.getters['picklist/skills/ID'];
      },
      set: function( value ) {
        return this.$store.dispatch( 'picklist/skills/SET_ID', value );
      }
    },        
    items: {
      get: function() {
      ...
      set: function( value ) {
        this.$store.dispatch( 'SET_SKILLS', value );
      }
    },
    name: {
      get: function() {
        return this.$store.getters['picklist/skills/NAME'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/skills/SET_NAME', value );
      }
    },
    original: {
      get: function() {
        return this.$store.getters['picklist/skills/ORIGINAL'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/skills/SET_ORIGINAL', value );
      }
    }
  },
  methods: {
    ...
    remove: function() {
      ...
      this.$store.dispatch( 'picklist/skills/REMOVE_SKILL', id );
    },
    save: function() {
      if( this.name === null ) {
      ...
      if( this.id === null ) {
        this.$store.dispatch( 'picklist/skills/CREATE_SKILL' );
      } else {
        this.$store.dispatch( 'picklist/skills/UPDATE_SKILL' );
      }
    }
  }
}
