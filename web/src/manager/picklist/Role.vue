...
export default {
  ...
  computed: {
    account: {
      get: function() {
        return this.$store.getters['picklist/roles/ACCOUNT'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/roles/SET_ACCOUNT', value );
      }
    },
    color: {
      get: function() {
        return this.$store.getters['picklist/roles/COLOR'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/roles/SET_COLOR', value );
      }
    },
    color_id: {
      get: function() {
        return this.$store.getters['picklist/roles/COLOR_ID'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/roles/SET_COLOR_ID', value );
      }
    },
    colors: {
      get: function() {
    ...
    count: {
      get: function() {
        return this.$store.getters['picklist/roles/COUNT'].toString();
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/roles/SET_COUNT', value );
      }
    },
    id: {
      get: function() {
        return this.$store.getters['picklist/roles/ID'];
      },
      set: function( value ) {
        return this.$store.dispatch( 'picklist/roles/SET_ID', value );
      }
    },        
    items: {
      get: function() {
      ...
      set: function( value ) {
        this.$store.dispatch( 'SET_ROLES', value );
      }
    },
    name: {
      get: function() {
        return this.$store.getters['picklist/roles/NAME'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/roles/SET_NAME', value );
      }
    },
    original: {
      get: function() {
        return this.$store.getters['picklist/roles/ORIGINAL'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/roles/SET_ORIGINAL', value );
      }
    }
  },
  methods: {
    ...
    remove: function() {
      ...
      this.$store.dispatch( 'picklist/roles/REMOVE_ROLE', id );
    },
    save: function() {
      if( this.name === null ) {
      ...
      if( this.id === null ) {
        this.$store.dispatch( 'picklist/roles/CREATE_ROLE' );
      } else {
        this.$store.dispatch( 'picklist/roles/UPDATE_ROLE' );
      }
    }
  }
}
