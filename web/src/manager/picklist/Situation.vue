...
export default {
  ...
  computed: {
    account: {
      get: function() {
        return this.$store.getters['picklist/situations/ACCOUNT'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/situations/SET_ACCOUNT', value );
      }
    },
    color: {
      get: function() {
        return this.$store.getters['picklist/situations/COLOR'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/situations/SET_COLOR', value );
      }
    },
    color_id: {
      get: function() {
        return this.$store.getters['picklist/situations/COLOR_ID'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/situations/SET_COLOR_ID', value );
      }
    },
    colors: {
      get: function() {
    ...
    count: {
      get: function() {
        return this.$store.getters['picklist/situations/COUNT'].toString();
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/situations/SET_COUNT', value );
      }
    },
    id: {
      get: function() {
        return this.$store.getters['picklist/situations/ID'];
      },
      set: function( value ) {
        return this.$store.dispatch( 'picklist/situations/SET_ID', value );
      }
    },        
    items: {
      get: function() {
      ...
      set: function( value ) {
        this.$store.dispatch( 'SET_SITUATIONS', value );
      }
    },
    name: {
      get: function() {
        return this.$store.getters['picklist/situations/NAME'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/situations/SET_NAME', value );
      }
    },
    original: {
      get: function() {
        return this.$store.getters['picklist/situations/ORIGINAL'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/situations/SET_ORIGINAL', value );
      }
    }
  },
  methods: {
    ...
    remove: function() {
      ...
      this.$store.dispatch( 'picklist/situations/REMOVE_SITUATION', id );
    },
    save: function() {
      if( this.name === null ) {
      ...
      if( this.id === null ) {
        this.$store.dispatch( 'picklist/situations/CREATE_SITUATION' );
      } else {
        this.$store.dispatch( 'picklist/situations/UPDATE_SITUATION' );
      }
    }
  }
}
