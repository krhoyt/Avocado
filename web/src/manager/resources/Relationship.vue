...
export default {
  ...
  computed: {
    account: {
      get: function() {
        return this.$store.getters['picklist/relationships/ACCOUNT'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/relationships/SET_ACCOUNT', value );
      }
    },
    color: {
      get: function() {
        return this.$store.getters['picklist/relationships/COLOR'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/relationships/SET_COLOR', value );
      }
    },
    color_id: {
      get: function() {
        return this.$store.getters['picklist/relationships/COLOR_ID'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/relationships/SET_COLOR_ID', value );
      }
    },
    colors: {
      get: function() {
    ...
    count: {
      get: function() {
        return this.$store.getters['picklist/relationships/COUNT'].toString();
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/relationships/SET_COUNT', value );
      }
    },
    id: {
      get: function() {
        return this.$store.getters['picklist/relationships/ID'];
      },
      set: function( value ) {
        return this.$store.dispatch( 'picklist/relationships/SET_ID', value );
      }
    },        
    items: {
      get: function() {
      ...
      set: function( value ) {
        this.$store.dispatch( 'SET_RELATIONSHIPS', value );
      }
    },
    name: {
      get: function() {
        return this.$store.getters['picklist/relationships/NAME'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/relationships/SET_NAME', value );
      }
    },
    original: {
      get: function() {
        return this.$store.getters['picklist/relationships/ORIGINAL'];
      },
      set: function( value ) {
        this.$store.dispatch( 'picklist/relationships/SET_ORIGINAL', value );
      }
    }
  },
  methods: {
    ...
    remove: function() {
      ...
      this.$store.dispatch( 'picklist/relationships/REMOVE_RELATIONSHIP', id );
    },
    save: function() {
      if( this.name === null ) {
      ...
      if( this.id === null ) {
        this.$store.dispatch( 'picklist/relationships/CREATE_RELATIONSHIP' );
      } else {
        this.$store.dispatch( 'picklist/relationships/UPDATE_RELATIONSHIP' );
      }
    }
  }
}
