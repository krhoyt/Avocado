...
router.get( '/:id', async ( req, res ) => {
  ...
  .from( 'Instagram' )
  .leftJoin( 'Developer', 'Instagram.developer_id', 'Developer.id' )
  .where( {
    'Instagram.uuid': req.params.id
  } )
  .first();
...
router.get( '/', async ( req, res ) => {
  ...
  .select(
    ...
    'Instagram.created_at',
    'Instagram.updated_at',
    'Instagram.uuid AS developer_id',
    'Instagram.profile'
  )
  .from( 'Instagram' )
  .leftJoin( 'Developer', 'Instagram.developer_id', 'Developer.id' )
  .orderBy( 'Instagram.updated_at' );
...
router.post( '/', async ( req, res ) => {
  ...
  if( req.query.hasOwnProperty( 'existing' ) ) {
    if( req.query.existing === 'true' ) {
      ...
      .leftJoin( 'Developer', 'Instagram.developer_id', 'Developer.id' )
      .where( {
        'Instagram.profile': record.profile
      } )
      .first();
